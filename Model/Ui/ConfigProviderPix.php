...
/**
 * Class Config Provider Pix - Defines properties of the payment form..
 */
class ConfigProviderPix implements ConfigProviderInterface
{
     ...
     * @const string
     */
    public const CODE = 'pagbank_paymentmagento_pix';
    ...
    public function getInstruction($storeId)
    {
        ...
        $time = $this->config->getTextTime($storeId);
    ...
    {
        $logo = [];
        $asset = $this->ccConfig->createAsset('PagBank_PaymentMagento::images/pix/logo.svg');
