define([
    ...
    return function (payload) {
        ...
        if (creditCardBin && creditCardBin.length === 6) {
            try {
                var requestData = {
                    creditCardBin: payload.creditCardBin,
                    cardTypeTransaction: payload.cardTypeTransaction || null,
                    customAmount: payload.customAmount ? { custom_amount: payload.customAmount } : null,
                    cardIndex: payload.cardIndex ? { card_index: payload.cardIndex } : null
                };
