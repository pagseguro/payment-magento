...
/**
 * Class Config Two Cc - Returns form of payment configuration properties for Credit Card.
 */
class ConfigTwoCc extends PaymentConfig
{
     ...
     * @const string
     */
    public const METHOD = 'pagbank_paymentmagento_two_cc';

    /**
     * @const string
     */
    public const CC_TYPES = 'payment/pagbank_paymentmagento_two_cc/cctypes';
